#!/usr/bin/env python3
"""
Test script to rename audio files in tests directory according to requirements:
- Change names to "razik"
- Add the time (duration) to the name
"""
...
def rename_audio_files_test():
    """Rename audio files in tests directory to 'razik' with duration"""
